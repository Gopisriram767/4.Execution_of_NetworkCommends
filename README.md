...
<BR>
In this EXPERIMENT- students have to understand basic networking commands e.g tcpdump, 
netstat, 
ifconfig, 
nslookup,
traceroute and also Capture ping and traceroute PDUs using a network protocol analyzer 
<BR>
